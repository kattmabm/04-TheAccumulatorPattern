...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(10, 16, 0.8)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 2
    answer = count_cosines_from(10, 16, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(1, 1000, 1)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 1.429  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(3, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 7.485  # This is APPROXIMATELY the correct answer.
